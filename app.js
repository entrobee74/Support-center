    ...
    <footer class="ss-footer" style="border-top:1px solid ${p.primaryColor}14;">
      <div class="ss-footer-inner">
        ...
        <p class="ss-disclaimer" style="color:${mc};font-family:${p.fontFamily};">
          ⚠ This is a demo support microsite generated by <strong>SupportCenterX</strong>.
          It is <strong>not</strong> the official ${p.name} support page. Do not enter real credentials.
        </p>
